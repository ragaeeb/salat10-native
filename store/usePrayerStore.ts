...
export const useFajrAngle = () => usePrayerStore((state) => safeParseFloat(state.settings.fajrAngle));
export const useIshaAngle = () => usePrayerStore((state) => safeParseFloat(state.settings.ishaAngle));
export const useIshaInterval = () => usePrayerStore((state) => safeParseFloat(state.settings.ishaInterval));
export const useLatitude = () => usePrayerStore((state) => safeParseFloat(state.settings.latitude));
export const useLongitude = () => usePrayerStore((state) => safeParseFloat(state.settings.longitude));
